                    ...
                    <div class="col-lg-6 col-xxl-6">
                        <div class="achivement-content-wrapper">
                            ...
                            <div class="title-wrap three" data-wow-duration="1.5s" data-wow-delay=".4s">
                                ...
                                <!--<h6 class="sec-title">Guiding Investors to Achieve Premium Returns and Financial Freedom</h6>-->
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                            ...
                            <div class="process-box">
                                <div class="process-img">
                                    ...
                                    <img src="{{ asset('public/assets/images/process/hm3-img01.webp') }}" alt="Idea Planning" class="main-img" style="clip-path: url(#clip-shape-1);" >
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                            ...
                            <div class="process-box style-2">
                                <div class="process-img">
                                    ...
                                    <img src="{{ asset('public/assets/images/process/hm3-img02.webp') }}" alt="Idea Planning" class="main-img" style="clip-path: url(#clip-shape-2);" >
                                </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                            ...
                            <div class="process-box style-3">
                                <div class="process-img">
                                    ...
                                    <img src="{{ asset('public/assets/images/process/hm3-img03.webp') }}" alt="Idea Planning" class="main-img" style="clip-path: url(#clip-shape-3);" >
                                </div>
