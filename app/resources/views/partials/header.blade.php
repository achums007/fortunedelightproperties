...
<head>
    ...
    <title>Fortune Delight Properties</title>
    <meta content="fdp - IT Solutions HTML5 Template" name="description">
    <meta content="fdp - IT Solutions HTML5 Template" name="keywords">
...
<body id="body">
    ...
    <div class="page-wrapper bg-light">
        ...
        Header Area
        ==============================-->
        <header class="tv-header {{ !request()->is('home') ? 'header-style1' : 'header-style6' }}">
        ...
        <div class="mobile-menu-wrapper">
            <div class="mobile-menu-area">
                ...
                <div class="mobile-logo">
                    <a href="index.html"><img alt="Pureflow" src="{{ asset('public/assets/image/logo/logo_header.png') }}"></a>
                </div>
