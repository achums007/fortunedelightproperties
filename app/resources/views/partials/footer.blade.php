                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-6 footer-brand">
                            <div class="brand-info wow fadeInUp" data-wow-delay=".2s">
                                <div class="logo">
                                    <img src="{{ asset('public/assets/image/logo/logo_header.png') }}" alt="fdp Logo" >
                                </div>
        ...
        <!--                        <div class="recent-post-item">-->
								<!--	<figure class="image">-->
								<!--		<a href="#"><img src="{{ asset('public/assets/images/footer/gallery-1.webp') }}" alt=""></a>-->
								<!--	</figure>-->
								...
								<!--	<figure class="image">-->
								<!--		<a href="#"><img src="{{ asset('public/assets/images/footer/gallery-2.webp') }}" alt=""></a>-->
								<!--	</figure>-->
								<!--	<div class="recent-post-info">-->
                    ...
                    <div class="row gy-15">
                        <div class="col-md-6">
                            <div class="copyright wow fadeInUp" data-wow-delay=".3s">
                                <p class="mb-0">Copyright &copy; 2025 FDP by <a class="text-theme" href="#">FDP</a>. All Rights Reserved. </p>
                            </div>
                        </div>
